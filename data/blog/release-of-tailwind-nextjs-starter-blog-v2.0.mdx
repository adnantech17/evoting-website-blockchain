---
title: 'Release of Tailwind Nextjs Starter Election v2.0'
date: '2023-08-05'
lastmod: '2023-08-05'
tags: ['next-js', 'tailwind', 'guide', 'feature']
draft: false
summary: 'Release of Tailwind Nextjs Starter Election template v2.0, refactored with Nextjs App directory and React Server Components setup.Discover the new features and how to migrate from V1.'
images: ['/static/images/twitter-card.png']
---

## Introduction

Welcome to the release of Tailwind Nextjs Starter Election template v2.0. This release is a major refactor of the codebase to support Nextjs App directory and React Server Components. Read on to discover the new features and how to migrate from V1.
...
- UI utility components
  - Bleed
  - Newsletter / Election Newsletter
  - Pre / Code block
  - Table of Contents
